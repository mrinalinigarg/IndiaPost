...
for i in range(num_loc):
	data_list[i].append(loc_id_list[i][7])
	#data_list[i].append(loc_id_list[i][0] - 1)

with open(pwd+'loc_to_circle.csv', 'w', newline = '') as fp_out: #Writing the values as list of lists in 1 go to decrease time complexity
