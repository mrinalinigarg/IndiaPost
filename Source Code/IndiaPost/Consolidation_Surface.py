...
def main():	
	'''
	if not(os.path.exists("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_NPH to NPH.xlsx")):
		os.makedirs("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_NPH to NPH.xlsx")
	else:
		pass
	if not(os.path.exists("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_NPH to SPH.xlsx")):
		os.makedirs("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_NPH to SPH.xlsx")
	else:
		pass
	if not(os.path.exists("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_SPH to NPH.xlsx")):
		os.makedirs("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_SPH to NPH.xlsx")
	else:
		pass
	if not(os.path.exists("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_SPH to SPH.xlsx")):
		os.makedirs("C:\\web2py_win\\web2py\\applications\\IndiaPost_UI\\Source Code\\IndiaPost\\Surface_SPH to SPH.xlsx")
	else:
		pass

	try:
		fp_in = openpyxl.load_workbook(curDir +'Surface_NPH to NPH.xlsx')
	...
	try:
		fp_in2 = openpyxl.load_workbook(curDir +'Surface_NPH to SPH.xlsx')
	...
	try:
		fp_in3 = openpyxl.load_workbook(curDir +'Surface_SPH to NPH.xlsx')
	...
	try:
		fp_in4 = openpyxl.load_workbook(curDir +'Surface_SPH to SPH.xlsx')
	...
	if(num_rows_ss>0):
		for i in range(num_rows_ss):
			...
			sheet_out.cell(row = serial_number+1, column = 7).fill = PatternFill(fgColor='FFEE08', fill_type = 'solid')
			a=float(sheet_in4.cell(row = i+2, column = 8).value)
			sheet_out.cell(row = serial_number+1, column = 8).value = format(a, '.2f')
			sheet_out.cell(row = serial_number+1, column = 8).fill = PatternFill(fgColor='FFEE08', fill_type = 'solid')
			sheet_out.cell(row = serial_number+1, column = 8).font = Font(bold=True)
