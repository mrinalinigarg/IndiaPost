	...
	if(num_rows>0):
		...
		for i in range(num_rows):
			...
			if(source_NPH_id ==dest_NPH_id):
				...
				list_transit_locations_air, list_transit_modes_air, list_transit_timestamps_air, arrival_datetime_air = opt_transit_nph_air(source_NPH_id, dest_SPH_id, dispatch_datetime,buffer_nph_dep, buffer_dest_air)
				air_arrival_datetime, air_datetime_dept, air_datetime_arr = closest_arrival(dispatch_datetime, list_air[source_NPH_id*num_locations + dest_SPH_id], buffer_nph_dep, buffer_dest_air)
				...
				list_transit_locations_air, list_transit_modes_air, list_transit_timestamps_air, arrival_datetime_air = opt_transit_nph_air(source_NPH_id, dest_NPH_id, dispatch_datetime,buffer_nph_dep, buffer_nph_arr)
				air_arrival_datetime, air_datetime_dept, air_datetime_arr = closest_arrival(dispatch_datetime, list_air[source_NPH_id*num_locations + dest_NPH_id], buffer_nph_dep, buffer_nph_arr)
				...
				list_transit_locations_air, list_transit_modes_air, list_transit_timestamps_air, arrival_datetime_air = opt_transit_nph_air(dest_NPH_id, dest_SPH_id, opt_overall_1[0],buffer_nph_dep, buffer_dest_air)
				air_arrival_datetime, air_datetime_dept, air_datetime_arr = closest_arrival(opt_overall_1[0], list_air[dest_NPH_id*num_locations + dest_SPH_id], buffer_nph_dep, buffer_dest_air)
