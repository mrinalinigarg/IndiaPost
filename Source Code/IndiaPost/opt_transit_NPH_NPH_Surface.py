...
def main():
	...
	if(num_rows>0):
		...
		#sheet_out.append(['Origin','Destination','Dispatch Time','Dispatch Day','Dept. from Origin','Day of Dept.','Arrival at TP1','Day of Arrival','Arrival at TP1 with buffer','Day of Arrival','Mode of Travel','TP1','Dept. from TP1','Day of Dept','Arrival at TP2','Day of Arrival','Arrival at TP2 With buffer','Day of Arrival','Mode of Travel','TP2','Dept. from TP2','Day of Dept','Arrival at TP3','Day of Arrival','Arrival at TP3 With buffer','Day of Arrival','Mode of Travel','TP3','Dept. from TP3','Day of Dept','Arrival at TP4','Day of Arrival','Arrival at TP4 With buffer','Day of Arrival','Mode of Travel','Destination','TotalTransit Time'])
		for i in range(num_rows):
			...
			#sheet_out.cell(row = i+2, column = 53).value = (time_diff/3600)
			#sheet_out.cell(row = i+2, column = 53).fill = PatternFill(fgColor='FFEE08', fill_type = 'solid')
			

			fp_out.save(curDir +'Surface_NPH to NPH.xlsx')
