	...
	if(num_rows>0):
		...
		for i in range(num_rows):
			...
			if(source_NPH_id ==dest_NPH_id):
				...
				opt_overall_1 = min([rail_arrival_datetime, [rail_datetime_dept, rail_datetime_arr, rail_arrival_datetime], [], ['2']], [road_arrival_datetime, [road_datetime_dept, road_datetime_arr, road_arrival_datetime], [], ['0']])
				...
				opt_overall_3 = min([rail_arrival_datetime, [rail_datetime_dept, rail_datetime_arr, rail_arrival_datetime], [], ['2']], [road_arrival_datetime, [road_datetime_dept, road_datetime_arr, road_arrival_datetime], [], ['0']])
			...
			fp_out.save(curDir +'Surface_SPH to SPH.xlsx')
